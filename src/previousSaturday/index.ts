...
export function previousSaturday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function previousSaturday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
