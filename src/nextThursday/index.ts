...
export function nextThursday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function nextThursday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
