...
export function previousSunday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function previousSunday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
