...
export function nextMonday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function nextMonday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
