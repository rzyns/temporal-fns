...
export function previousTuesday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function previousTuesday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
