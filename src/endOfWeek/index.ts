...
export function endOfWeek(date: Temporal.PlainDateTime, options?: WeekOptions): Temporal.PlainDateTime;
export function endOfWeek(date: Temporal.PlainDate, options?: WeekOptions): Temporal.PlainDate;
export function endOfWeek(date: AnyTemporalDate, options?: WeekOptions): AnyTemporalDate {
  ...
  return result.with({ hour: 23, minute: 59, second: 59, millisecond: 999, microsecond: 999, nanosecond: 999 });
}
