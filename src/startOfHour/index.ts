...
export function startOfHour(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function startOfHour(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
