...
export function startOfSecond(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function startOfSecond(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
