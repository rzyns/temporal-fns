...
export function nextTuesday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function nextTuesday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
