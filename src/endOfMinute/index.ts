...
export function endOfMinute(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function endOfMinute(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
