 ...
 */
export function setHours(date: Temporal.ZonedDateTime, hours: number): Temporal.ZonedDateTime;
export function setHours(date: Temporal.PlainDateTime, hours: number): Temporal.PlainDateTime;
export function setHours(date: AnyTemporalDateTime, hours: number): AnyTemporalDateTime {
