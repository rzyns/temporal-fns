...
export function nextWednesday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function nextWednesday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
