...
export function endOfSecond(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function endOfSecond(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
