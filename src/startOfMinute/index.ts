...
export function startOfMinute(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function startOfMinute(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
