 ...
 */
export function setMilliseconds(date: Temporal.ZonedDateTime, milliseconds: number): Temporal.ZonedDateTime;
export function setMilliseconds(date: Temporal.PlainDateTime, milliseconds: number): Temporal.PlainDateTime;
export function setMilliseconds(date: AnyTemporalDateTime, milliseconds: number): AnyTemporalDateTime {
