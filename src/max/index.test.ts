...
describe("max", (it) => {
    it("returns the latest PlainDate from an array", ({ expect }) => {
        const dates = [
    ...
    it("returns the latest PlainDateTime from an array", ({ expect }) => {
        const dates = [
    ...
    it("returns the latest ZonedDateTime from an array", ({ expect }) => {
        const dates = [
