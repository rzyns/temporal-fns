...
export function previousWednesday(date: Temporal.ZonedDateTime): Temporal.ZonedDateTime;
export function previousWednesday(date: Temporal.PlainDateTime): Temporal.PlainDateTime;
